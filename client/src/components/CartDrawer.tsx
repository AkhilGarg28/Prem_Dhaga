  ...
  return (
    <>
      <button
        ...
        onClick={handleClose}
        className="fixed inset-0 z-50 cursor-default bg-temple-black opacity-[0.68] animate-fade-in"
      />

      <aside
        className="fixed bottom-0 right-0 top-0 z-50 flex w-full max-w-[480px] flex-col overflow-hidden border-l border-royal-gold/22 bg-[#100d09] shadow-[0_0_110px_rgba(0,0,0,.55)] animate-drawer-in"
